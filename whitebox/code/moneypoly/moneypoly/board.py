...
class Board:
    ...
    def _create_properties(self):
        ...
        g = self.groups
        return [
            Property.create("Mediterranean Avenue",   1,  60,  2,  g["brown"]),
            Property.create("Baltic Avenue",          3,  60,  4,  g["brown"]),
            Property.create("Oriental Avenue",        6,  100, 6,  g["light_blue"]),
            Property.create("Vermont Avenue",         8,  100, 6,  g["light_blue"]),
            Property.create("Connecticut Avenue",     9,  120, 8,  g["light_blue"]),
            Property.create("St. Charles Place",      11, 140, 10, g["pink"]),
            Property.create("States Avenue",          13, 140, 10, g["pink"]),
            Property.create("Virginia Avenue",        14, 160, 12, g["pink"]),
            Property.create("St. James Place",        16, 180, 14, g["orange"]),
            Property.create("Tennessee Avenue",       18, 180, 14, g["orange"]),
            Property.create("New York Avenue",        19, 200, 16, g["orange"]),
            Property.create("Kentucky Avenue",        21, 220, 18, g["red"]),
            Property.create("Indiana Avenue",         23, 220, 18, g["red"]),
            Property.create("Illinois Avenue",        24, 240, 20, g["red"]),
            Property.create("Atlantic Avenue",        26, 260, 22, g["yellow"]),
            Property.create("Ventnor Avenue",         27, 260, 22, g["yellow"]),
            Property.create("Marvin Gardens",         29, 280, 24, g["yellow"]),
            Property.create("Pacific Avenue",         31, 300, 26, g["green"]),
            Property.create("North Carolina Avenue",  32, 300, 26, g["green"]),
            Property.create("Pennsylvania Avenue",    34, 320, 28, g["green"]),
            Property.create("Park Place",             37, 350, 35, g["dark_blue"]),
            Property.create("Boardwalk",              39, 400, 50, g["dark_blue"]),
        ]
